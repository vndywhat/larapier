...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\BbCodeService $instance */
                        return $instance->parse($source, $caseInsensitive);
        }
                    /**
         * Remove all BBCode
         *
        ...
        {
                        /** @var \App\Services\BbCodeService $instance */
                        return $instance->stripBBCodeTags($source);
        }
                    /**
        ...
        {
                        /** @var \App\Services\BbCodeService $instance */
                        return $instance->parseCaseSensitive($source);
        }
                    /**
        ...
        {
                        /** @var \App\Services\BbCodeService $instance */
                        return $instance->parseCaseInsensitive($source);
        }
                    /**
        ...
        {
                        /** @var \App\Services\BbCodeService $instance */
                        $instance->setParser($name, $pattern, $replace, $content);
        }
...
namespace  { 
            ...
            class BbCode extends \App\Facades\BbCode {}
